...
from SOFT_M2TD3.replay_buffer import ReplayBuffer
from SOFT_M2TD3.network import (
    PolicyNetwork,
    CriticNetwork,
    EtaNetwork,
)
...
class TD3:
    ...
    def _select_etaNet(self):
        ...
        select_index = np.random.choice(a=self.element_list, size=1, p=self.etaNet_prob)
